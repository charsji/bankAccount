...
package com.hodo.jjaccount.service;

import com.github.wxiaoqi.security.common.data.IUserDepartDataService;
import com.hodo.jjaccount.biz.MyUserBiz;
 ...
 */
@Component
public class MyUserDepartDataService implements IUserDepartDataService {
    @Autowired
    private MyUserBiz userFeign;

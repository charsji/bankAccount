 ...
 */
@Configuration
public class MyMybatisDataConfig {
    ...
    public void init() {
         ...
         */
        sqlSessionFactory.getConfiguration().addInterceptor(new MybatisDataInterceptor(userDepartDataService, "com.github.wxiaoqi.security.admin.client.mapper.UserMapper.selectOne", "com.github.wxiaoqi.security.admin.client.mapper.UserMapper.selectByPrimaryKey", "com.github.wxiaoqi.security.admin.client.mapper.DepartMapper.getDepartById"));
    }
}
